...
export function createUser(user) {
  ...
  axios
    .post("https://backbebidas.onrender.com/usuario", {
      id: user.id,
      nombre: user.nombre,
...
export function updateUser(user) {
  ...
  console.log("user", user);
  let updated = axios
    .put("https://backbebidas.onrender.com/usuario", {
      user,
    })
    .then((res) => res.data)
    .catch((e) => console.log(e));
  ...
  return async (dispatch) => {
    try {
      let usersFound = await axios
        .get("https://backbebidas.onrender.com/usuario")
  ...
  return async (dispatch) => {
    try {
      let userFound = await axios
        .get("https://backbebidas.onrender.com/usuario/" + id)
        .then((users) => users.data);
...
export const getProducts = () => {
  return async function (dispatch) {
    try {
      let result = await axios.get(`https://backbebidas.onrender.com/producto/bebidas`);
      return dispatch({
        type: GET_PRODUCTS,
        payload: result.data,
      });
  ...
  return async function (dispatch) {
    try {
      let result = await axios.get(
        `https://backbebidas.onrender.com/producto/bebidas?nombre=${name}`
      );
...
export const getProductById = (id) => {
  return async function (dispatch) {
    try {
      let result = await axios.get(
        "https://backbebidas.onrender.com/producto/bebida/" + id
      );
      return dispatch({
        type: GET_PRODUCT_ID,
        payload: result.data,
  ...
  return async function (dispatch) {
    try {
      let result = await axios.put(
        "https://backbebidas.onrender.com/producto/bebida",
        prod
      );
      return dispatch({
        type: UPDATE_PRODUCT,
  ...
  return async function (dispatch) {
    try {
      let result = await axios.post(
        "https://backbebidas.onrender.com/usuario/carrito",
        localStorage
      );
...
export const getMercadoPago = () => {
  return async function (dispatch) {
    try {
      let result = await axios.post("https://backbebidas.onrender.com/usuario/checkout");
...
export const deleteMercadoPago = () => {
  return async function (dispatch) {
    try {
      let result = await axios.delete("https://backbebidas.onrender.com/usuario/checkout");
...
export const feedBack = () => {
  return async function (dispatch) {
    try {
      let result = await axios.get("https://backbebidas.onrender.com/usuario/feedback");
...
export const postReview = (payload) => {
  return async function (dispatch) {
    try {
      let result = await axios.post("https://backbebidas.onrender.com/review/", payload);
      return dispatch({
        type: POST_REVIEW,
      });
    } catch (e) {
...
export const getAllReviews = () => {
  return async function (dispatch) {
    try {
      let result = await axios.get("https://backbebidas.onrender.com/review/all");
...
export const getReview = (id) => {
  return async function (dispatch) {
    try {
      let result = await axios.get("https://backbebidas.onrender.com/review/" + id);
...
export const getReviewPage = () => {
  return async function (dispatch) {
    try {
      let result = await axios.get("https://backbebidas.onrender.com/review");
...
export const putReview = (payload) => {
  return async function (dispatch) {
    try {
      let result = await axios.put("https://backbebidas.onrender.com/review/", payload);
...
export const deleteReview = (id) => {
  return async function (dispatch) {
    try {
      let result = await axios.delete("https://backbebidas.onrender.com/review/" + id);
      return dispatch({
        type: DELETE_REVIEW,
      });
    } catch (e) {
...
export const findReviewId = (id) => {
  return async function (dispatch) {
    try {
      let result = await axios.get(
        "https://backbebidas.onrender.com/review/putreview/" + id
      );
...
export const getReviewByUser = (id) => {
  return async function (dispatch) {
    try {
      let result = await axios.get("https://backbebidas.onrender.com/review/all/" + id);
      return dispatch({
...
export const setFavorito = (payload) => {
  return async function (dispatch) {
    try {
      let result = await axios.post("https://backbebidas.onrender.com/producto", payload);
      return dispatch({
        type: SET_FAV,
        return: payload,
      });
...
export const getUserById = (id) => {
  return async function (dispatch) {
    try {
      let result = await axios.get("https://backbebidas.onrender.com/usuario/" + id);
      return dispatch({
        type: GET_USER_BY_ID,
        payload: result.data,
      });
...
export const getFavorito = (id) => {
  return async function (dispatch) {
    try {
      let result = await axios.get(
        `https://backbebidas.onrender.com/producto/favoritos/${id}`
      );
      console.log("result.data", result.data);
      return dispatch({
        type: GET_FAV,
  ...
  return async function (dispatch) {
    try {
      ...
      let result = await axios.delete(
        `https://backbebidas.onrender.com/producto/favoritos?id_prod=${id_prod}&&id_user=${id_user}`
      );
...
export const addDirecciones = (payload) => {
  return async function (dispatch) {
    try {
      let result = await axios.post(
        "https://backbebidas.onrender.com/usuario/direcciones",
        payload
      );
      return dispatch({
...
export const deleteDirecciones = (id) => {
  return async function (dispatch) {
    try {
      let result = await axios.delete(
        `https://backbebidas.onrender.com/usuario/direcciones/${id}`
      );
...
export const addHist = (payload) => {
  return async function (dispatch) {
    let historial = await axios.post(
      "https://backbebidas.onrender.com/producto/historial",
      payload
    );
    console.log(
      payload,
  ...
  return async function (dispatch) {
    try {
      let historial = await axios.get(
        `https://backbebidas.onrender.com/producto/historial/${id}`
      );
...
export const createProduct = (prod) => {
  return async function (dispatch) {
    try {
      await axios.post("https://backbebidas.onrender.com/producto/bebida", prod);
    } catch (e) {
      console.log(e);
    }
  };
...
export const getStats = () => {
  return async function (dispatch) {
    try {
      let result = await axios.get("https://backbebidas.onrender.com/usuario/admin/stats");
...
export const getTopProds = (top) => {
  ...
  return async function (dispatch) {
    try {
      let result = await axios.post(
        "https://backbebidas.onrender.com/usuario/admin/stats/products",
        { top: top }
      );
...
export const adminDeleteProd = (id) => {
  return async function (dispatch) {
    try {
      await axios.delete(`https://backbebidas.onrender.com/producto/bebida/${id}`);
    } catch (err) {
      console.log(err);
    }
  };
